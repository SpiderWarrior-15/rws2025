...
export const AIBuddy: React.FC = () => {
  ...
  const [messages, setMessages] = useState<AIMessage[]>([
    {
      id: '1',
      content: "👋 Hey there, mighty warrior! I'm your AI buddy here to help you navigate the Royal Warriors Squad. Ask me anything about the platform, get tips, or just chat!",
      isUser: false,
      timestamp: new Date()
    }
  ]);
